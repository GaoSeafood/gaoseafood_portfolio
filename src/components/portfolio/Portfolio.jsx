...
const PROJECTS = [
  ...
  {
    id: 6,
    title: "浙江卫视「Z视介」2周年：杭州中心视效联动宣传片",
    icon: wenhuaIcon,
  ...
  {
    id: 7,
    title: "个人AIGC孵化项目：从0到1搭建情感共鸣类AI短视频账号",
    icon: aiVideoIcon,
  ...
  {
    id: 8,
    title: "Vide Coding实战：全流程 AIGC 短视频创作画布",
    icon: null,
    ...
    <section className="portfolio" ref={rootRef} aria-label="作品集">
      <div className="pf-intro-wrap">
        <div className="pf-intro">
          ...
          <p className="pf-id">
            精选作品案例 — 从品牌视频到短视频运营，从内容策划到AI工具搭建。
          </p>
        </div>
      </div>
